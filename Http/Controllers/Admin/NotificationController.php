...
use Modules\Inotification\Http\Requests\CreateNotificationRequest;
use Modules\Inotification\Http\Requests\UpdateNotificationRequest;
...
class NotificationController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        return view('inotification::admin.notifications.index', compact(''));
    }
    ...
    {
        return view('inotification::admin.notifications.create');
    }
